...
public class ByCategoryReportHandler implements IReportHandler {
    ...
    public ByCategoryReportHandler(RestReportService restReportService) {
    ...
    public byte[] handle(RequestParamsDto params) {
        ...
        for (String account : accounts) {
            ...
            filteredList.sort(Comparator.comparing(OperationDto::getOperationCategory)
                    .thenComparing(OperationDto::getDate));
            ...
            for (OperationDto dto : filteredList) {
                ...
                newRow.createCell(0).setCellValue(categories.get(dto.getOperationCategory()));
                newRow.createCell(1).setCellValue(dto.getDate().toString());
                newRow.createCell(2).setCellValue(dto.getOperationValue());
